...
void xSepia_STD::testYUVtoRGBtoYUV_INT(xPic &Dst, const xPic &Src)
{
  ...
  for (int32 y = 0; y < Height; y++)
  {
    for (int32 x = 0; x < Width; x++)
    {
      ...
      // change data format (and remove chroma offset)
      const int32V4 SrcPixelYUV_F32I = {
      ...
      // convert YCbCr --> RGB (BT.709)
      const int32V4 SrcPixelRGB_F32I = {
          (SrcPixelYUV_F32I[0] + SrcPixelYUV_F32I[2] * YCbCr2RGB_F32I[0][2] + 32768) >> 16,
          (SrcPixelYUV_F32I[0] + SrcPixelYUV_F32I[1] * YCbCr2RGB_F32I[1][1] + SrcPixelYUV_F32I[2] * YCbCr2RGB_F32I[1][2] + 32768) >> 16,
          (SrcPixelYUV_F32I[0] + SrcPixelYUV_F32I[1] * YCbCr2RGB_F32I[2][1] + 32768) >> 16,
          0};

      // copy RGB --> RGB
      const int32V4 DstPixelRGB_F32I = SrcPixelRGB_F32I;

      // convert RGB --> YCbCr (BT.709)
      const int32V4 DstPixelYUV_F32I = {
          (int32)(((DstPixelRGB_F32I[0] * RGB2YCbCr_F32I[0][0] + DstPixelRGB_F32I[1] * RGB2YCbCr_F32I[0][1] + DstPixelRGB_F32I[2] * RGB2YCbCr_F32I[0][2]) + 32768) >> 16),
          (int32)(((DstPixelRGB_F32I[0] * RGB2YCbCr_F32I[1][0] + DstPixelRGB_F32I[1] * RGB2YCbCr_F32I[1][1] + DstPixelRGB_F32I[2] * RGB2YCbCr_F32I[1][2]) + 32768) >> 16),
          (int32)(((DstPixelRGB_F32I[0] * RGB2YCbCr_F32I[2][0] + DstPixelRGB_F32I[1] * RGB2YCbCr_F32I[2][1] + DstPixelRGB_F32I[2] * RGB2YCbCr_F32I[2][2]) + 32768) >> 16),
          0};

      // change data format (and apply chroma offset) + clip to range 0-Max
      int32V4 TmpPixelYUV_F32I = DstPixelYUV_F32I + int32V4(0, DstMidValue, DstMidValue, 0);
      TmpPixelYUV_F32I.clip(xMakeVec4<int32>(0), xMakeVec4<int32>(DstMaxValue));
      const uint16V4 DstPixelYUV_U16 = uint16V4(TmpPixelYUV_F32I);
...
void xSepia_STD::applySepiaEffect_INT(xPic &Dst, const xPic &Src)
{
  ...
  for (int32 y = 0; y < Height; y++)
  {
    for (int32 x = 0; x < Width; x++)
    {
      ...
      // apply sepia effect
      const int32V4 DstPixelRGB_F32I = {
          (SrcPixelRGB_F32I[0] * SEPIA_F32I[0][0] + SrcPixelRGB_F32I[1] * SEPIA_F32I[0][1] + SrcPixelRGB_F32I[2] * SEPIA_F32I[0][2] + 32768) >> 16,
          (SrcPixelRGB_F32I[0] * SEPIA_F32I[1][0] + SrcPixelRGB_F32I[1] * SEPIA_F32I[1][1] + SrcPixelRGB_F32I[2] * SEPIA_F32I[1][2] + 32768) >> 16,
          (SrcPixelRGB_F32I[0] * SEPIA_F32I[2][0] + SrcPixelRGB_F32I[1] * SEPIA_F32I[2][1] + SrcPixelRGB_F32I[2] * SEPIA_F32I[2][2] + 32768) >> 16,
          0};
