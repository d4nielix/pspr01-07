  ...
  if (((uint32)Width & (uint32)c_RemainderMask8) == 0) // Width%8==0
  {
    for (int32 y = 0; y < Height; y++)
    {
      for (int32 x = 0; x < Width; x += 8)
      {
        ...
        // apply sepia effect
        /* TEMPLATE const flt32V4 DstPixelRGB_F32 =
          {
              SrcPixelRGB_F32[0] * SEPIA_F32[0][0] + ( SrcPixelRGB_F32[1] * SEPIA_F32[0][1] + SrcPixelRGB_F32[2] * SEPIA_F32[0][2] ),
              SrcPixelRGB_F32[0] * SEPIA_F32[1][0] + ( SrcPixelRGB_F32[1] * SEPIA_F32[1][1] + SrcPixelRGB_F32[2] * SEPIA_F32[1][2] ),
              SrcPixelRGB_F32[0] * SEPIA_F32[2][0] + ( SrcPixelRGB_F32[1] * SEPIA_F32[2][1] + SrcPixelRGB_F32[2] * SEPIA_F32[2][2] ),
              0};
        */
        __m128 DstR0_F32 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(SrcG0_F32, _mm_set1_ps(SEPIA_F32[0][1])), _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[0][2]))), _mm_mul_ps(SrcR0_F32, _mm_set1_ps(SEPIA_F32[0][0])));
        __m128 DstR1_F32 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(SrcG1_F32, _mm_set1_ps(SEPIA_F32[0][1])), _mm_mul_ps(SrcB1_F32, _mm_set1_ps(SEPIA_F32[0][2]))), _mm_mul_ps(SrcR1_F32, _mm_set1_ps(SEPIA_F32[0][0])));
        __m128 DstG0_F32 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(SrcG0_F32, _mm_set1_ps(SEPIA_F32[1][1])), _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[1][2]))), _mm_mul_ps(SrcR0_F32, _mm_set1_ps(SEPIA_F32[1][0])));
        __m128 DstG1_F32 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(SrcG1_F32, _mm_set1_ps(SEPIA_F32[1][1])), _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[1][2]))), _mm_mul_ps(SrcR1_F32, _mm_set1_ps(SEPIA_F32[1][0])));
        __m128 DstB0_F32 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(SrcG0_F32, _mm_set1_ps(SEPIA_F32[2][1])), _mm_mul_ps(SrcB0_F32, _mm_set1_ps(SEPIA_F32[2][2]))), _mm_mul_ps(SrcR0_F32, _mm_set1_ps(SEPIA_F32[2][0])));
        __m128 DstB1_F32 = _mm_add_ps(_mm_add_ps(_mm_mul_ps(SrcG1_F32, _mm_set1_ps(SEPIA_F32[2][1])), _mm_mul_ps(SrcB1_F32, _mm_set1_ps(SEPIA_F32[2][2]))), _mm_mul_ps(SrcR1_F32, _mm_set1_ps(SEPIA_F32[2][0])));
